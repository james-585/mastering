...
WAV exports. See docs/design-history/STORY-001/{requirements,architecture}.md
for the full spec this package implements against.
...
def _ensure_suno_dsp_on_path() -> None:
    ...
    """
    repo_root = frozen_root() if is_frozen() else Path(__file__).resolve().parents[2]
    candidate_dirs = [
