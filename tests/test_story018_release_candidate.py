...
from suno_mastering.tools.release_candidate import cli as release_cli


REPO_ROOT = Path(__file__).resolve().parents[1]
CLI_ENTRY = [sys.executable, "-m", "suno_mastering.tools.release_candidate"]
PYTHONPATH_FOR_SUBPROCESS = str(REPO_ROOT / "src")
