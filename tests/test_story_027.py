...
Run fast suite only:
    pytest tests/test_story_027.py -m "not slow"

Run full suite:
    pytest tests/test_story_027.py

All pytest calls must be run from the repo root (venv activated).
"""
